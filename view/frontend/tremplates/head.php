...
<head>
  ...
  <link href="./public/frontend/vendor/fontawesome-free/css/all.min.css" rel="stylesheet">
  ...
  <link href="./public/frontend/css/grayscale.min.css" rel="stylesheet">
  <link rel="stylesheet" href="./public/frontend/css/scroll.css">
  <link rel="stylesheet" href="./public/frontend/css/conect.css">
</head>
<body id="page-top">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        ...
        <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="index.php?action=blog">Le Roman</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="index.php?action=contact">Contact</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="index.php?action=connect">Se Connecter</a>
          </li>
        </ul>
      </div>
    </div>
...
<script src="./public/frontend/js/grayscale.min.js"></script>
