                                                ...
                                                <div class="au-task__item au-task__item--primary">
                                                    <div class="au-task__item-inner">
                                                        <h5 class="task">
                                                            ...
                                                            <hr>
                                                            <span> Publié le - <?php echo $comment['comment_date_fr']; ?></span>
                                                            <hr>
                                                            <p><?php echo nl2br(htmlspecialchars($comment['comment'])); ?></p>
                                                            
                                                        </h5>
                                                        <div class="au-message__item-time">
                                                                <p><?php echo $comment['ee']; ?></p>
                                                                <form   style="margin-top: 5px;"   id="contactForm"   action="controller/backend/delete_comment.php" method="POST"> 
